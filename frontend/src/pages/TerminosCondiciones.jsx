          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
                ...
                <li>Distribución de hasta 500,000 reproducciones en plataformas de streaming (Spotify, Apple Music, etc.).</li>
              ...
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
                ...
                <li>Reproducciones ilimitadas en plataformas de streaming.</li>
