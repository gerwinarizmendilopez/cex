...
export const AudioPlayer = ({ src, beatName }) => {
  ...
  return (
    <div className="bg-zinc-900 border border-red-900/20 rounded-xl p-6">
      <audio ref={audioRef} src={src} preload="metadata" />
      
      <div className="flex items-center gap-4 mb-4">
        <button
          onClick={togglePlay}
          className="w-14 h-14 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-colors flex-shrink-0"
        >
          {isPlaying ? (
