...
export const GlobalAudioPlayer = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-black to-zinc-900 border-t border-red-900/50 shadow-2xl">
      {/* Waveform */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              size="lg"
              className={`rounded-full w-14 h-14 ${isPlaying ? 'bg-white text-black hover:bg-gray-200' : 'bg-red-600 hover:bg-red-700'}`}
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <input
                ...
                className="w-24 h-1.5 rounded-full cursor-pointer accent-red-500 bg-zinc-700"
              />
            </div>
